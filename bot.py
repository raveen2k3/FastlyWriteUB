...
@fastly.on_message(filters.photo & filters.chat(chats=[-1001266552555,-1001355881913,-1001577467953,-1001577467953]) & filters.user(users=[ 1877720720 , 1983714367 , 5053950120]))
